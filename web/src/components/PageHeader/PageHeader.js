...
import playlistIcon from '../../assets/images/icons/playlistsIcon.png'
        ...
        <header className="page-header">
            <Link to="/playlists" className="list-types"> 
                <div className="div-playlist">
                    <img src={playlistIcon} alt="playlists" className="icons" id="playlists-icon"/>
                    <h3>Playlists</h3>
                </div>
            </Link>
            ...
            <Link to="/create_playlist" className="homepage"> 
                <div className="div-logo">
                    <h2>FavPL</h2>
                    <img src={logoIcon} alt="logo" className="icons" id="logo-icon"/>
                </div>
            </Link>
        </header>
    );
